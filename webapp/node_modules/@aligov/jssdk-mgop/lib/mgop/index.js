...
var _jssdkUtils = require("@aligov/jssdk-utils");

var _env = _interopRequireDefault(require("./env"));

var _responseCode = _interopRequireDefault(require("./responseCode"));

var _universalRequest = _interopRequireDefault(require("universal-request"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var isWeb = _jssdkUtils.global.isWeb;

var globalInstance = _jssdkUtils.global.getGlobal();

var debug = _jssdkUtils.logger.debug,
    warning = _jssdkUtils.logger.warning;
var getTokenFromCookie = _jssdkUtils.token.getTokenFromCookie,
    getTimeStamp = _jssdkUtils.token.getTimeStamp;
var CONST_VARIABLE = {
  TOKEN_KEY: "_mgw_tk",
...
var Mgop = /*#__PURE__*/function () {
  ...
  _proto.processToken = function processToken(timestamp) {
    ...
    var stringifyParams = (0, _jssdkUtils.stringifyQS)({
      token: token || "",
      ak: appkey,
      api: api,
      ts: timestamp,
    ...
    return (0, _jssdkUtils.md5)(stringifyParams);
  };

  _proto.processRequestUrl = function processRequestUrl() {
    /* 获取官网的 host */
    var host = (0, _env.default)(this.config.env, this.config.host);
    ...
    var query = "" + (0, _jssdkUtils.stringifyQS)(param);
    return {
  ...
  _proto.processResponseResult = function processResponseResult(response) {
    ...
    switch (formatCode) {
      case _responseCode.default.ResultSuccess:
        return this.createSuccessCb(response.data || {});

      case _responseCode.default.FAIL_SYS_TOKEN_EMPTY:
        debug(_NAME_, _responseCode.default.FAIL_SYS_TOKEN_EMPTY, "令牌为空，重试");
        ...
        debug(_NAME_, _responseCode.default.FAIL_SYS_TOKEN_EMPTY, "令牌为空，且超过最大重试次数");
        return "";
  ...
  _proto.processRequest = function processRequest() {
    ...
    if (isWeb && _jssdkUtils.webViewEnv.isAlipayMini() && AlipayMiniAppCall) {
      var host = (0, _env.default)(this.config.env, this.config.host);
      ...
      return (0, _universalRequest.default)({
        method: METHOD,
        url: url,
        headers: headers,
        data: data
