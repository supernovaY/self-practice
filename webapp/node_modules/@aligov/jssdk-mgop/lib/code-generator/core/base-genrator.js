...
exports.createBaseIndexStr = createBaseIndexStr;
exports.createSystemsIndexStr = createSystemsIndexStr;
exports.createSystemStr = createSystemStr;
exports.createSystemModelStr = createSystemModelStr;
...
var packageName = (0, _utils.getPackageName)();
/**
 * 生成 index.js | index.ts
 */

function createBaseIndexStr(codeType, info) {
  var host = info.host,
      appKey = info.appKey;
...
function createSystemsIndexStr(codeType, systems) {
...
function createSystemStr(codeType, system) {
  var apiList = system.apiList;

  if (codeType === "Javascript") {
    return "\n    " + (0, _tools.createModuleHeadHelpStr)(system) + "\n\n    export default function(sendFetch) {\n      return {\n        " + apiList.map(function (itf) {
      var apiName = itf.apiName;
      return "\n\n            " + (0, _tools.creatInterfaceHelpStr)(itf) + "\n           '" + apiName + "': (data= {}, header = {}) => {\n    \n              return sendFetch({\n                api: '" + apiName + "',\n                data,\n                header\n              });;\n           }\n          ";
    }) + "\n      }\n    }\n  \n  ";
  } else {
    return "\n    " + (0, _tools.createModuleHeadHelpStr)(system) + "\n\n    export default function(sendFetch) {\n      return {\n        " + apiList.map(function (itf) {
      var apiName = itf.apiName;
...
function createSystemModelStr(system) {
...
function createRequestTypes(interfaces) {
