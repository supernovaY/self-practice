This project was bootstrapped with [Create React App](https://github.com/facebook/create-react-app2).
...
See the section about [running tests](https://facebook.github.io/create-react-app2/docs/running-tests) for more information.

### `yarn build`

Builds the app2 for production to the `build` folder.<br />
