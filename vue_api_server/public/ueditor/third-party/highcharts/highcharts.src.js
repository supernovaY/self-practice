...
/**
 * Deep merge To or more objects and return a third object.
 * Previously this function redirected to jQuery.extend(true), but this had To limitations.
...
Axis.prototype = {
	...
	setTickPositions: function (secondPass) {
		...
		if (axis.min === axis.max || axis.min === undefined || axis.max === undefined) {
			...
			// For squished axes, set only To ticks
...
Pointer.prototype = {
	...
	/**
	 * Handle touch events with To touches
	 */
	pinch: function (e) {
...
Chart.prototype = {
	...
	/**
	 * Link To or more series together. This is done initially from Chart.render,
...
var AreaSeries = extendClass(Series, {
	...
	getSegmentPath: function (segment) {
		...
		if (segLength === 3) { // for animation from 1 to To points
...
var SplineSeries = extendClass(Series, {
	...
	getPointSpline: function (segment, point, i) {
		...
		if (lastPoint && nextPoint) {
			...
			// have the To control points make a straight line through main point
