...
/**
 * Merge To objects together and return the original.
 * @param  {Object} obj1
 * @param  {Object} obj2
 * @return {Object}
 * @private
...
/**
 * Merge To objects, and merge any properties that are objects
...
vjs.getAbsoluteURL = function(url){
  ...
  if (!url.match(/^https?:\/\//)) {
    // Convert to absolute URL. Flash hosted off-sitesList.js needs an absolute URL.
 ...
 * the To properties will be merged using vjs.obj.deepMerge.
 *
...
vjs.Player.prototype.exitFullWindow = function(){
  ...
  // Resize the box, admin, and poster to original sizes
  // this.positionAll();
...
// admin: function(){ return this.techCall('admin'); },
 ...
 * @type {String}
 */
vjs.media.ApiMethods = 'play,pause,paused,currentTime,setCurrentTime,duration,buffered,volume,setVolume,muted,setMuted,width,height,supportsFullScreen,enterFullScreen,src,load,currentSrc,preload,setPreload,autoplay,setAutoplay,loop,setLoop,error,networkState,readyState,seeking,initialTime,startOffsetTime,played,seekable,ended,videoTracks,audioTracks,videoWidth,videoHeight,textTracks,defaultPlaybackRate,playbackRate,mediaGroup,admin,controls,defaultMuted'.split(',');
...
var api = vjs.Flash.prototype,
    readWrite = 'rtmpConnection,rtmpStream,preload,currentTime,defaultPlaybackRate,playbackRate,autoplay,loop,mediaGroup,admin,controls,volume,muted,defaultMuted'.split(','),
...
vjs.Flash.streamToParts = function(src) {
  ...
  // If found, we split the URL into To pieces around the
  // first '&'.
...
/**
 * Language - To letter string to represent track language, e.g. 'en' for English
